...
| `STOCK_MARKET_DATA_JOBS` | `fetchers/stock_market_data/` 对应 job | 8 |
| `ALL_JOBS` | 所有 `JobSpec` 汇总 | 51 |
...
| Profile | Job 数量 |
| --- | --- |
| `trade_day_post_close_core` | 7 |
| `trade_day_post_close_extended` | 20 |
| `trade_day_pre_open` | 5 |
| `financial_calendar_nightly` | 9 |
