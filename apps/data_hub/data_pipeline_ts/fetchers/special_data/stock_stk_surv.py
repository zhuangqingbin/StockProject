...
class StkSurvFetch(BaseFetcher):
    ...
    table_schema = TableSchema(
        columns={
            ...
            "rece_place": ColumnDef("TEXT", nullable=True, comment="接待地点"),
            "rece_mode": ColumnDef("TEXT", nullable=True, comment="接待方式"),
            ...
            "content": ColumnDef("LONGTEXT", nullable=True, comment="调研内容"),
        },
        composite_indexes=[
            ("surv_date",),
            ("surv_date", "ts_code"),
